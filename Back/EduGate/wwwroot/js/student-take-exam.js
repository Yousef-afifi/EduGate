/* Page script: pages/student/take-exam.html */
/* ============================================================
...
populateSidebarUser();
  ...
  document.querySelectorAll('#sidebar-nav .nav-item').forEach((item) => {
    if (item.getAttribute('href') === '/Student/Exams') item.classList.add('active');
  });
      ...
      <div class="exam-layout">
        <div style="background:var(--white);border-radius:var(--radius);padding:40px;text-align:center;box-shadow:var(--shadow-lg);border:1px solid var(--gray-200);max-width:560px;margin:0 auto">
          ...
          <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap">
            <button class="btn-secondary" onclick="window.location.href='/Student/Exams'">Back to Exams</button>
  ...
  function submitExam() {
    ...
    submitMvcForm('/Student/Exams/Submit', fields);
  }
      ...
      <div class="exam-layout">
        <div class="result-card">
          ...
          <div style="display:flex;gap:12px;justify-content:center">
            <button class="btn-secondary" onclick="window.location.href='/Student/Exams'" style="padding:12px 24px">Back to Exams</button>
            <button class="btn-primary" onclick="window.location.href='/Student/Dashboard'" style="padding:12px 24px">Go to Dashboard</button>
          </div>
        </div>
      </div>`;
  }
