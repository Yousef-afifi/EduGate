/* Page script: pages/teacher//Teacher/Exams */
/* ============================================================
...
populateSidebarUser();
  ...
  document.querySelectorAll('#sidebar-nav .nav-item').forEach((item) => {
    ...
    if (href === '/Teacher/Exams') item.classList.add('active');
  });
                ...
                <tr>
                  ...
                  <td>
                    <div style="display:flex;gap:8px">
                      ...
                      <button class="btn-amber" style="padding:6px 12px;font-size:12px" onclick="window.location.href='/Teacher/TakeExam?id=${exam.id}&preview=true'">Preview</button>
                    </div>
                  </td>
                </tr>
              `).join('')}
