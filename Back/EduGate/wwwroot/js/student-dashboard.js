/* Page script: pages/student//Student/Dashboard */
/* ============================================================
...
populateSidebarUser();
  ...
  const teacherNav = [
    { icon: '&#127968;', label: 'Dashboard', page: '/Student/Dashboard', view: 'overview' },
  ...
  document.querySelectorAll('#sidebar-nav .nav-item[data-view]').forEach((item) => {
    item.addEventListener('click', (event) => {
      ...
      window.history.replaceState({}, '', currentView === 'overview' ? '/Student/Dashboard' : `/Student/Dashboard?view=${currentView}`);
      loadCurrentView();
      syncActiveNav();
      document.getElementById('sidebar').classList.remove('open');
      document.getElementById('sidebar-overlay').style.display = 'none';
  ...
  function syncActiveNav() {
    ...
    const active = document.querySelector(`#sidebar-nav .nav-item[data-view="${activeView}"]`)
      || document.querySelector('#sidebar-nav .nav-item[data-page="/Student/Dashboard"]');
  ...
  async function renderTeacherOverview() {
    ...
    document.getElementById('dashboard-content').innerHTML = `
      ...
      <div class="section-header">
        ...
        <a href="/Student/Courses" class="section-link">Manage all courses</a>
      </div>
  ...
  async function renderStudentOverview() {
    ...
    document.getElementById('dashboard-content').innerHTML = `
      ...
      <div class="section-header">
        ...
        <a href="/Student/Courses" class="section-link">Open all courses</a>
      </div>
      ...
      <div class="section-header" style="margin-top:40px">
        ...
        <a href="/Student/Exams" class="section-link">See exam page</a>
      </div>
  ...
  window.openTeacherGenerateAccounts = () => {
    ...
    window.history.replaceState({}, '', '/Student/Dashboard?view=generate-students');
    syncActiveNav();
    renderTeacherGenerateStudents();
  };
  ...
  window.backToTeacherStudents = () => {
    ...
    window.history.replaceState({}, '', '/Student/Dashboard?view=students');
    syncActiveNav();
